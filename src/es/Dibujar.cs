...
namespace Logo
{
	...
	public static class Dibujar
	{
		...
		{
			return new Elemento(CoreGraphics.AddEllipse(false, x, y, ancho, alto, color));
		}
		...
		{
			return new Elemento(CoreGraphics.AddLine(x1, y1, x2, y2, color));
		}
		...
		{
			return new Elemento(CoreGraphics.AddRectangle(false, x, y, ancho, alto, color));
		}
		...
		{
			return new Elemento(CoreGraphics.AddTriangle(false, x1, y1, x2, y2, x3, y3, color));
		}
